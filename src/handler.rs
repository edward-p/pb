...
#[post("/", data = "<paste>")]
pub async fn paste(pb_config: &State<PbConfig>, paste: Form<Paste>) -> io::Result<String> {
...
#[get("/<id>/<lang>")]
pub async fn syntax_highlighting(
    id: &str,
    lang: &str,
    pb_config: &State<PbConfig>,
...
#[get("/u/<id>")]
pub async fn retrieve_url(id: &str, pb_config: &State<PbConfig>) -> io::Result<Option<Redirect>> {
...
#[delete("/<id>")]
pub async fn delete_content(id: &str, pb_config: &State<PbConfig>) -> io::Result<&'static str> {
    fs::remove_file(Path::new(&pb_config.pb_data).join("content").join(id)).await?;
    Ok("Done!\n")
}

#[delete("/u/<id>")]
pub async fn delete_url(id: &str, pb_config: &State<PbConfig>) -> io::Result<&'static str> {
